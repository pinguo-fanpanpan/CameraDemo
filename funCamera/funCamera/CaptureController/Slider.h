...
//  funCamera
//
//  Created by camera360 on 14-10-22.
...
@optional
- (void)didChangeValueSCSlider:(Slider*)slider value:(CGFloat)value;
- (void)didSCSliderTouchEnd:(Slider*)slider value:(CGFloat)value isTouch:(BOOL)isTouchEnd;
